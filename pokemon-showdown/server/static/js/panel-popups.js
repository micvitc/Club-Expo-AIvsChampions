...
_this5.setState({showMuteInput:true,showBanInput:false,showLockInput:false});
ev.preventDefault();
ev.stopImmediatePropagation();
};_this5.
handleBan=function(ev){
_this5.setState({showBanInput:true,showMuteInput:false,showLockInput:false});
ev.preventDefault();
ev.stopImmediatePropagation();
};_this5.
handleLock=function(ev){
_this5.setState({showLockInput:true,showMuteInput:false,showBanInput:false});
ev.preventDefault();
ev.stopImmediatePropagation();
};_this5.

handleCancel=function(ev){
_this5.setState({showBanInput:false,showMuteInput:false,showLockInput:false,showConfirm:false});
ev.preventDefault();
ev.stopImmediatePropagation();
};_this5.
...
var _this5$getTargets2=_this5.getTargets(),targetUser=_this5$getTargets2.targetUser,targetRoom=_this5$getTargets2.targetRoom;
targetRoom==null||targetRoom.send("/friend add "+targetUser);
_this5.setState({requestSent:true});
ev.preventDefault();
ev.stopImmediatePropagation();
};_this5.

handleIgnore=function(){
var _this5$getTargets3=_this5.getTargets(),targetUser=_this5$getTargets3.targetUser,targetRoom=_this5$getTargets3.targetRoom;
targetRoom==null||targetRoom.send("/ignore "+targetUser);
_this5.close();
};_this5.

handleUnignore=function(){
var _this5$getTargets4=_this5.getTargets(),targetUser=_this5$getTargets4.targetUser,targetRoom=_this5$getTargets4.targetRoom;
targetRoom==null||targetRoom.send("/unignore "+targetUser);
_this5.close();
};_this5.

muteUser=function(ev){var _this5$base;
_this5.setState({showMuteInput:false});
var hrMute=ev.currentTarget.value==="1hr";
var reason=(_this5$base=_this5.base)==null||(_this5$base=_this5$base.querySelector("input[name=mutereason]"))==null?void 0:_this5$base.value;
var data={
action:'Mute',
reason:reason,
duration:hrMute?"1 hour":"7 minutes"
};
_this5.setState({data:data,showConfirm:true});
ev.preventDefault();
ev.stopImmediatePropagation();
};_this5.

banUser=function(ev){var _this5$base2;
_this5.setState({showBanInput:false});
var weekBan=ev.currentTarget.value==="1wk";
var reason=(_this5$base2=_this5.base)==null||(_this5$base2=_this5$base2.querySelector("input[name=banreason]"))==null?void 0:_this5$base2.value;
var data={
action:'Ban',
reason:reason,
...
lockUser=function(ev){var _this5$base3;
_this5.setState({showLockInput:false});
var weekLock=ev.currentTarget.value==="1wk";
var isNamelock=ev.currentTarget.value==="nmlk";
var reason=(_this5$base3=_this5.base)==null||(_this5$base3=_this5$base3.querySelector("input[name=lockreason]"))==null?void 0:_this5$base3.value;
var data={
...
return false;
};return _this5;}_inheritsLoose(UserOptionsPanel,_PSRoomPanel2);var _proto4=UserOptionsPanel.prototype;_proto4.getTargets=function getTargets(){var _targetRoom,_targetRoom2,_targetRoom3,_targetRoom4,_targetRoom5;var _PSUtils$splitFirst=PSUtils.splitFirst(this.props.room.id,'-',2),targetUser=_PSUtils$splitFirst[1],targetRoomid=_PSUtils$splitFirst[2];var targetRoom=PS.rooms[targetRoomid]||null;if(((_targetRoom=targetRoom)==null?void 0:_targetRoom.type)!=='chat')targetRoom=(_targetRoom2=targetRoom)==null?void 0:_targetRoom2.getParent();if(((_targetRoom3=targetRoom)==null?void 0:_targetRoom3.type)!=='chat')targetRoom=(_targetRoom4=targetRoom)==null?void 0:_targetRoom4.getParent();if(((_targetRoom5=targetRoom)==null?void 0:_targetRoom5.type)!=='chat')targetRoom=null;return{targetUser:targetUser,targetRoomid:targetRoomid,targetRoom:targetRoom};};_proto4.

render=function render(){var _this6=this,_this$state$data,_this$state$data2,_this$state$data3;
var room=this.props.room;
var banPerms=["@","#","~"];
...
if(actionName==='mute'){
return canMute&&!_this6.state.showLockInput&&!_this6.state.showBanInput&&!_this6.state.showConfirm;
}
if(actionName==='ban'){
return canBan&&!_this6.state.showLockInput&&!_this6.state.showMuteInput&&!_this6.state.showConfirm;
}
if(actionName==='lock'){
return canLock&&!_this6.state.showBanInput&&!_this6.state.showMuteInput&&!_this6.state.showConfirm;
}
};
...
VolumePanel=function(_PSRoomPanel4){function VolumePanel(){var _this7;for(var _len4=arguments.length,args=new Array(_len4),_key4=0;_key4<_len4;_key4++){args[_key4]=arguments[_key4];}_this7=_PSRoomPanel4.call.apply(_PSRoomPanel4,[this].concat(args))||this;_this7.
...
PS.update();
};return _this7;}_inheritsLoose(VolumePanel,_PSRoomPanel4);var _proto6=VolumePanel.prototype;_proto6.
...
OptionsPanel=function(_PSRoomPanel5){function OptionsPanel(){var _this9;for(var _len5=arguments.length,args=new Array(_len5),_key5=0;_key5<_len5;_key5++){args[_key5]=arguments[_key5];}_this9=_PSRoomPanel5.call.apply(_PSRoomPanel5,[this].concat(args))||this;_this9.
...
};return _this9;}_inheritsLoose(OptionsPanel,_PSRoomPanel5);var _proto7=OptionsPanel.prototype;_proto7.componentDidMount=function componentDidMount(){_PSRoomPanel5.prototype.componentDidMount.call(this);this.subscribeTo(PS.user);};_proto7.
...
var sideBySideDisabled=!!battleRoom&&battleRoom.width<500;
...
preact.h("option",{value:"side-by-side",disabled:sideBySideDisabled},
BATTLE_LAYOUT_LABELS['side-by-side']," (DESKTOP)"
),
preact.h("option",{value:"side-by-side-overlay",disabled:sideBySideDisabled},
...
componentDidMount=function componentDidMount(){var _room$args11,_this22=this;
