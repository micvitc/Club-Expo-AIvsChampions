...
_this=_PSRoom.call(this,options)||this;_this.classType='ladder';_this.format=_this.id.split('-')[1];_this.notice=void 0;_this.searchValue='';_this.loading=false;_this.error=void 0;_this.ladderData=void 0;_this.ladderHTML=void 0;_this.
...
setLadderHTML=function(ladderHTML){
_this.loading=false;
_this.error=undefined;
_this.ladderData=undefined;
_this.ladderHTML=ladderHTML;
_this.update(null);
};_this.
...
var prefix=toID(_this.searchValue);
PS.send("/cmd laddertop "+_this.format+(prefix?" ,"+prefix:''));
...
renderLocalLadder=function renderLocalLadder(){
var room=this.props.room;
...
return preact.h(SanitizedHTML,null,room.ladderHTML);
};_proto.
