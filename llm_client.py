...
class SingleBattleDecision(BaseModel):
    ...
    rival_dialogue: str = Field(description="A short, in-character taunt or line of dialogue as Blue (from Pokemon Red/Blue/Silver) talking directly to his rival Red about this turn's actions. Be slightly cocky, competitive, but respect Red's power. Keep it under 1-2 sentences.")
    ...
    async def get_decision(self, prompt: str, schema: Any) -> Optional[dict]:
        ...
        if schema == SingleBattleDecision:
            schema_info = (
                ...
                '  "rival_dialogue": "A short, cocky/rival dialogue as Blue to Red about this turn.",\n'
